...
public class sample1_11  implements ActionListener{
    ...
    String strLabel[] = {" Midter Score : "," Final Score :", "Homework Score :"};
    ...
    public sample1_11() {
        ...
        c.add(new JLabe;l("Enter Student no : "));
        c.add(studentNo);
        c.add(btnOk);
        c.add(btnAll);
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        else if (event.getSource() == btnAll) {showAll();}
    }
...
JOptionPane.showMessageDialog(null,str);
    ...
    public static void main(String[] args){
        sample1_11 object = new sample1_11();
    }
